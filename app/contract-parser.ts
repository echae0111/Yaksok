...
export const ANALYSIS_VERSION = "parser-18_legal-citations-1_full-evidence-1_spacing-1_body-regions-1_column-layout-1_article-boundaries-2_no-cross-clause-merge-1_semantic-coverage-2_source-lineage-3_effects-2_prompt-23_korean-only-1_ocr-4_gemini-3.1-pro-preview";
